...
int main()
{
    ...
    */
    ...
    // Zadanie 11 (przeciwprostokatna trojkata)
    /*
    double a, b;
    printf("Podaj dlugosc przyprostokatnych: ");
    scanf("%lf %lf", &a, &b);
    printf("Przeciwprostokatna wynosi: %lf", pow(a*a + b*b, 1.0/2));
    */

    // Zadanie 12 (wartosc bezwgledna)
    /*
    int x1;
    printf("Podaj liczbe calkowita: ");
    scanf("%d", &x1);
    if(x1 > 0) {
        printf("Wartosc bezwgledna wynosi: %d", x1);
    } else {
        printf("Wartosc bezwgledna wynosi: %d", -x1);
    }
    */
    ...
    // Zadanie 13 (wartosc bezwgledna - zmiennoprzecinkowe)
    /*
    double x1;
    printf("Podaj liczbe zmiennoprzecinkowa: ");
    scanf("%lf", &x1);
    if(x1 > 0) {
        printf("Wartosc bezwgledna wynosi: %lf", x1);
    } else {
        printf("Wartosc bezwgledna wynosi: %lf", -x1);
    }
    */
    ...
    // Zadanie 14 (przyklad braku lacznosci)
    /*
    printf("(0.1 + 0.2) + 0.3 = %.24lf\n", (0.1 + 0.2) + 0.3);
    printf("0.1 + (0.2 + 0.3) = %.24lf\n", 0.1 + (0.2 + 0.3));
    */
